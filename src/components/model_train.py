...
# purposely for training all kinds of models

#can also use for confusion metrix
...
class ModelTrainer:
    ...
    def initiate_model_training(self, train_array, test_array):
        ...
        try:
            ...
            best_model_names = list(model_report.keys())[list(model_report.values()).index(best_model_score)]
